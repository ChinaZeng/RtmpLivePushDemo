...
import com.zzw.live.encodec.BaseMediaEncoder;
...
//            putPcmThread.setExit(true);
    ...
    private void startRecode(int samplerate, int bit, int channels) {
        ...
        videoEncodeRecode.setOnMediaInfoListener(new BaseMediaEncoder.OnMediaInfoListener() {
            @Override
        ...
        videoEncodeRecode.setOnStatusChangeListener(new BaseMediaEncoder.OnStatusChangeListener() {
            @Override
